...
- 2026-06 (refino visual): Nova identidade "neutro sofisticado + índigo discreto" (fundo off-white, texto grafite, acento índigo #4F46E5, header grafite #171A21). Acabamento leve: bordas 1px, sombras suaves (TACTILE_CARD reescrito), removida a profundidade "3D" (borderBottom 3/4px), cantos menos arredondados (28→22, 20→16) e mais respiro na Home. Categorias com tiles sóbrios uniformes (sem "arco-íris"). Aplicado globalmente via tokens + refactor mecânico em 13 arquivos. Verificado por screenshots (login, home, loja, painel do lojista).
